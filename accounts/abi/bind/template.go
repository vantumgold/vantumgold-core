...
import "github.com/vntg-project/vntg/accounts/abi"
...
{{range $contract := .Contracts}}
	public class {{.Type}} {
		...
		// vntg address where this contract is located at.
		public final Address Address;

		// vntg transaction in which this contract was deployed (if known!).
