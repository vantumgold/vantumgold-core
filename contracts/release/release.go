...
type Config struct {
	Oracle common.Address // vntg address of the release oracle
...
func (r *ReleaseService) checkVersion() {
	...
	if version.Major > r.config.Major ||
		...
		howtofix := fmt.Sprintf("Please check https://github.com/vntg-project/vntg/releases for new releases")
