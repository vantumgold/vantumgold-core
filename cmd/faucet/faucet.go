...
import (
	...
	"github.com/vntg-project/vntg/ethclient"
...
type request struct {
	...
	Account common.Address     `json:"account"` // vntg address being funded
...
type faucet struct {
	...
	stack  *node.Node          // vntg protocol stack
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/vntg-project/vntg/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
